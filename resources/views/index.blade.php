...
@section('content')
	...
	<form action="/pegawai/cari" method="GET" class="form-inline">  <!-- form-inline (dipaksa 1 baris) -->
    ...
    {{ $pegawai->links() }}  <!-- hanya bisa di pakai dengan peginate , saat get() harus dihapus -->
@endsection
